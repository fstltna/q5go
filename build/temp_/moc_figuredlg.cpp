/****************************************************************************
** Meta object code from reading C++ file 'figuredlg.h'
**
...
#include <memory>
#include "../../src/figuredlg.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'figuredlg.h' doesn't include <QObject>."
...
void *FigureDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::FigureDialog"))
        return static_cast< Ui::FigureDialog*>(this);
