/****************************************************************************
** Meta object code from reading C++ file 'telnet.h'
**
...
#error "The header file 'telnet.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 18), // "slotHostDisconnect"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 12) // "slotHostQuit"

    },
    "TelnetConnection\0slotHostDisconnect\0"
    "\0slotHostQuit"
};
...
void TelnetConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->slotHostDisconnect(); break;
        case 1: _t->slotHostQuit(); break;
        default: ;
        }
    }
    (void)_a;
